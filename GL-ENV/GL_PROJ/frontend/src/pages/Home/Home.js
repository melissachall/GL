...
{/* <!-- ===================================================About=================================================== --> */}
        <div class="grid grid-cols-1 lg:grid-cols-[600px_1fr] relative my-[50px]">
            ...
            <img class="absolute w-[150px] hidden lg:block lg:bottom-[-50px] lg:inset-x-1/4" src={images[11]} />
            <div>
...
{/* <!-- ===================================================Last Announces=================================================== --> */}
        ...
        {/* <img class="absolute w-[150px] hidden lg:block lg:bottom-[20px] lg:inset-x-3/4" src={images[4]}/> */}
            ...
            <img class="absolute w-[100px] hidden lg:block lg:bottom-0 lg:inset-x-1/4" src={images[11]} />
            <div class="my-[50px] mx-[50px]">
